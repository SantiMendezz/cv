    ...
    return (
        <footer>
            ...
            <div className={styles['footer-item']}>
                ...
                <button onClick={handleClick} className={styles['footer-button']} target='_blank' rel='noopener noreferrer'>
            ...
            <div className={styles['footer-item']}>
                <p className={styles['footer-copy']}>Desarrollado por Santiago Méndez</p>
            </div>
        </footer>
    )
}
